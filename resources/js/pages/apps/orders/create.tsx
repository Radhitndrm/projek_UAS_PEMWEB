...
export default function Create() {
    ...
    const { products, suppliers } = usePage<CreateProps>().props;
    ...
    useEffect(() => {
        ...
        const grandPrice = updatedItems.reduce(
        ...
        <>
            ...
            <div className="w-full">
                <Header
                    ...
                    subtitle="Halaman ini digunakan untuk menambahkan data pembelian"
                />
                <div className="p-6">
                    <Card>
                                                ...
                                                >
                                                    ...
                                                    <TableCell className="align-top">
                                                        <Input
                                                            ...
                                                            className="cursor-not-allowed focus:ring-0"
                                                        />
                                                    </TableCell>
                                                </TableRow>
                                            ))}
