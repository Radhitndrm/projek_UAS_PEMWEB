                                ...
                                <TableBody>
                                    {reportsData.products.map((report, reportIndex) => (
                                        <React.Fragment key={reportIndex}>
                                            <TableRow>
                                                <TableCell colSpan={5} className='bg-gray-100 dark:bg-gray-900 font-semibold text-center capitalize'>
                                                    {report.name}
                                                </TableCell>
                                            </TableRow>
                        ...
                        <TableCard className='mt-6'>
                            <Table>
                                <TableHeader>
                                    ...
                                    <TableRow>
                                        {[1, 2, 3, 4, 5].map(i => (
                                            <TableHead key={i}><Skeleton className='w-16 h-4' /></TableHead>
                                        ))}
                                    </TableRow>
                                </TableHeader>
                                    ...
                                    {Array.from({ length: 3 }).map((_, i) => (
                                        <TableRow key={i}>
                                            {Array.from({ length: 5 }).map((_, j) => (
                                                <TableCell key={j}><Skeleton className='w-16 h-4' /></TableCell>
                                            ))}
                                        </TableRow>
                                    ))}
                                </TableBody>
